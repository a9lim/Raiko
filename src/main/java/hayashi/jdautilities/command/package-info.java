...
/**
 * Items in this package pertain to the {@link hayashi.jdautilities.command.CommandClient CommandClient} and
 * {@link hayashi.jdautilities.command.Command Commands}.
 * 
 * <p>All of the contents are used heavily in the {@link hayashi.jdautilities.command.impl.CommandClientImpl CommandClientImpl},
 * and are summarized as follows:
 * <ul>
 *     <li>{@link hayashi.jdautilities.command.AnnotatedModuleCompiler AnnotatedModuleCompiler}
 *     <br>An interface to create Commands from annotated objects (More info on annotated commands can be found in the
 *     {@link hayashi.jdautilities.command.annotation.JDACommand JDACommand} documentation).</li>
 *
 *     <li>{@link hayashi.jdautilities.command.CommandBuilder CommandBuilder}
 *     <br>An chain builder for Commands.</li>
 *
 *     <li>{@link hayashi.jdautilities.command.Command Command}
 *     <br>An abstract class that can be inherited by classes to create Commands compatible with the
 *     {@code CommandClientImpl}.</li>
 *
 *     <li>{@link hayashi.jdautilities.command.CommandClient CommandClient}
 *     <br>An interface used for getting info set when building a {@code CommandClientImpl}.</li>
 *
 *     <li>{@link hayashi.jdautilities.command.CommandClientBuilder CommandClientBuilder}
 *     <br>A builder system used to create a {@code CommandClientImpl} across several optional chained methods.</li>
 *
 *     <li>{@link hayashi.jdautilities.command.CommandEvent CommandEvent}
 ...
 *
 *     <li>{@link hayashi.jdautilities.command.CommandListener CommandListener}
 ...
 *
 *     <li>{@link hayashi.jdautilities.command.GuildSettingsManager GuildSettingsManager}
 *     <br>An abstract object used to store and handle {@code GuildSettingsProvider} implementations.</li>
 *
 *     <li>{@link hayashi.jdautilities.command.GuildSettingsProvider GuildSettingsProvider}

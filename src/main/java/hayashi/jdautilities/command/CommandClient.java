 ...
 * @implNote While typically safe, there are a few ways to misuse the standard implementation of this interface:
...
public interface CommandClient {
     ...
     * @throws java.lang.IllegalArgumentException If the Command provided has a name or alias that has already been registered
     */
     ...
     *
     * @param command The Command to add
     * @param index   The index to add the Command at (must follow the specifications {@code 0<=index<=size()})
     * @throws java.lang.ArrayIndexOutOfBoundsException If {@code index < 0} or {@code index > size()}
     * @throws java.lang.IllegalArgumentException       If the Command provided has a name or alias that has already been registered to an index
     */
     ...
     * JDACommand.Module JDACommand.Module} into a {@link java.util.List
     ...
     *
     * @param module      An object annotated with JDACommand.Module to compile into commands to be added.
     * @param mapFunction The Function to get indexes for each compiled Command with when adding them to the CommandClient.
     * @throws java.lang.ArrayIndexOutOfBoundsException If {@code index < 0} or {@code index > size()}
     * @throws java.lang.IllegalArgumentException       If the Command provided has a name or alias that has already been registered to an index
     */
